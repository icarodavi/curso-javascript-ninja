(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Icaro Monteiro'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'juazeirense'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function (a, b, c) {
